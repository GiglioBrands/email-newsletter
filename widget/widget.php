...
<div>
  ...
  <div class="eemail_button">
    <input class="eemail_textbox_button" name="eemail_txt_Button" id="eemail_txt_Button" onClick="return eemail_submit_ajax('<?php echo emailnews_plugin_url('widget'); ?>','<?php echo eemail_my_app_id(); ?>')" value="<?php echo get_option('eemail_widget_but_cap'); ?>" type="button">
  </div>
</div>